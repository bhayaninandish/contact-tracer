  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav ml-auto pr-4 abc">
      <li class="nav-item active">
        <a class="nav-link" href="#cust-form">Customer Form <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="#whytracer">Why Contact Tracer?</a>
      </li>
...
<div class="main_header">
        <div class="row w-100 h-100 mt-5 mb-5">
            ...
            <div class="rightside ml-5">
                <h1>Contact Tracer For Cor<span class="covid"><img src="images/coronavirus.png" height="50" width="50"alt=""></span>na Virus</h1>
                </div>
...
<div class="container-fluid pt-5 pb-5" id="whytracer">
        <div class="section_header text-center mb-5 mt-5">
          <h1 id="symptoms">Why Contact Tracer?</h1>
            
        </div>

    <div class="container">
        <center>
        <iframe width="420" height="345" src="https://www.youtube.com/embed/SXd-byofNfE"> </iframe>
...
<div class="container-fluid pt-5 pb-5" >
        <div class="section_header text-center mb-5 mt-4" id="store">
          <h1 id="cust-form">Customer Registration</h1>
            <?php include "cust_form.php"; ?>
        </div>
      </div>
